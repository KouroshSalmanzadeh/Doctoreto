...
export const doctors: DoctorDetailsModel[] = [
    {
        ...
        about: "متخصص بیماریهای داخلی با ۱۵ سال سابقه، عضو انجمن گوارش ایران، دارای تجربه در درمان بیماریهای کبد و کلیه",
        phone: "051-37215430",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "فوق تخصص نوزادان با تمرکز بر واکسیناسیون و سلامت کودکان، عضو هیئت علمی دانشگاه علوم پزشکی تهران",
        phone: "021-22784590",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        about: "جراح عمومی با تخصص در جراحیهای سرپایی، عضو انجمن جراحان ایران، دارای گواهینامه بین‌المللی لاپاراسکوپی",
        phone: "031-36258741",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "فوق تخصص ناباروری و جراحیهای زیبایی زنان، عضو انجمن زنان و مامایی ایران، دارای گواهینامه بین‌المللی IVF",
        phone: "071-37269520",
        services_types: [
            {
                type: "tell",
    ...
    },
    {
        ...
        about: "متخصص آنژیوپلاستی و الکتروفیزیولوژی قلب، عضو انجمن قلب اروپا (ESC)، دارای تجربه در جراحیهای پیچیده قلبی",
        phone: "041-35264710",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "متخصص پوست و مو با تخصص در لیزرتراپی و بیماری‌های مقاربتی، عضو انجمن درماتولوژی ایران، دارای گواهینامه بین‌المللی لیزر از آلمان",
        phone: "026-34256789",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        about: "فوق تخصص نورولوژی با تمرکز بر بیماری‌های ام‌اس و صرع، عضو هیئت علمی دانشگاه علوم پزشکی قم، دارای گواهینامه EEG پیشرفته",
        phone: "025-37894512",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "متخصص گوارش و کبد با ۱۲ سال سابقه، عضو انجمن گوارش اروپا (UEG)، دارای تخصص در آندوسکوپی درمانی",
        phone: "013-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "فوق تخصص نفرولوژی و پیوند کلیه، عضو انجمن بین‌المللی نفرولوژی، دارای تجربه در انجام دیالیز پیچیده",
        phone: "061-35264789",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        about: "انکولوژیست و هماتولوژیست با تخصص در پیوند مغز استخوان، عضو انجمن سرطان اروپا (ESMO)، دارای گواهینامه طب تسکینی",
        phone: "034-33784521",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "متخصص روماتولوژی با تمرکز بر بیماری‌های مفصلی و خودایمنی، عضو انجمن روماتولوژی ایران، دارای گواهینامه تزریق داخل مفصلی",
        phone: "035-36258741",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "فوق تخصص طب فیزیکی و توان‌بخشی، عضو انجمن فیزیاتری ایران، دارای گواهینامه تزریق اپیدورال و بلوک عصبی",
        phone: "044-33659874",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        about: "متخصص پزشکی هسته‌ای با تمرکز بر درمان سرطان و تصویربرداری پیشرفته، عضو انجمن پزشکی هسته‌ای اروپا (EANM)",
        phone: "054-33784521",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "پزشک قانونی با تخصص در تشخیص علل مرگ و بررسی جراحات، عضو هیئت علمی دانشگاه علوم پزشکی هرمزگان",
        phone: "076-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "متخصص پزشکی ورزشی با تمرکز بر آسیب‌های ورزشی و بازتوانی، عضو انجمن پزشکی ورزشی ایران، دارای گواهینامه توان‌بخشی ورزشی",
        phone: "081-35264789",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        about: "فوق تخصص چشم پزشکی با تمرکز بر جراحی شبکیه و گلوکوم، عضو انجمن چشم پزشکی ایران، دارای گواهینامه لیزر شبکیه",
        phone: "011-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "متخصص گوش، حلق و بینی با تخصص در جراحی سینوس و درمان وزوز گوش، عضو انجمن ENT ایران، دارای گواهینامه جراحی آندوسکوپیک",
        phone: "017-35264789",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "فوق تخصص ارتوپدی با تمرکز بر جراحی زانو و درمان شکستگی‌ها، عضو انجمن ارتوپدی ایران، دارای گواهینامه جراحی آرتروسکوپی",
        phone: "028-33659874",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        about: "متخصص بیماری‌های عفونی با تمرکز بر درمان HIV و سل، عضو انجمن عفونی ایران، دارای گواهینامه درمان عفونت‌های مقاوم",
        phone: "086-35264789",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        about: "فوق تخصص غدد و متابولیسم با تمرکز بر درمان دیابت و اختلالات تیروئید، عضو انجمن غدد ایران، دارای گواهینامه درمان دیابت پیشرفته",
        phone: "083-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "male",
        address: "شیراز - خیابان زند - کوچه گلستان",
        about: "فوق تخصص روانپزشکی با تمرکز بر درمان افسردگی و اضطراب، عضو انجمن روانپزشکی ایران، دارای گواهینامه روان درمانی شناختی",
        phone: "071-35264789",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        gender: "female",
        address: "تبریز - خیابان امام - کوچه سلامت",
        about: "متخصص آلرژی و ایمونولوژی با تمرکز بر درمان آلرژی و آسم، عضو انجمن آلرژی ایران، دارای گواهینامه تست‌های پوستی پیشرفته",
        phone: "041-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "male",
        address: "کرج - خیابان بهار - کوچه نسترن",
        about: "متخصص اورژانس با تمرکز بر مدیریت تروما و احیای قلبی ریوی، عضو انجمن اورژانس ایران، دارای گواهینامه ATLS و ACLS",
        phone: "026-35264789",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "male",
        address: "قم - خیابان معلم - کوچه دانش",
        about: "متخصص طب سنتی با تمرکز بر درمان با گیاهان دارویی و حجامت، عضو انجمن طب سنتی ایران، دارای گواهینامه طب سوزنی",
        phone: "025-33659874",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        gender: "female",
        address: "رشت - خیابان مطهری - کوچه سبز",
        about: "متخصص طب سوزنی با تمرکز بر درمان دردهای مزمن و میگرن، عضو انجمن طب سوزنی ایران، دارای گواهینامه بین‌المللی طب سوزنی",
        phone: "013-35264789",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "male",
        address: "اهواز - خیابان نفت - کوچه نارنج",
        about: "متخصص طب کار با تمرکز بر معاینات دوره‌ای و درمان بیماری‌های شغلی، عضو انجمن طب کار ایران، دارای گواهینامه ارزیابی ریسک شغلی",
        phone: "061-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "female",
        address: "کرمان - خیابان شریعتی - کوچه گل",
        about: "فوق تخصص طب سالمندان با تمرکز بر درمان پوکی استخوان و آلزایمر، عضو انجمن سالمندان ایران، دارای گواهینامه طب سالمندان پیشرفته",
        phone: "034-35264789",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        gender: "male",
        address: "یزد - خیابان امام - کوچه کویر",
        about: "متخصص طب مسافرت با تمرکز بر واکسیناسیون و درمان بیماری‌های مناطق گرمسیری، عضو انجمن طب مسافرت ایران، دارای گواهینامه بین‌المللی طب مسافرت",
        phone: "035-33659874",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "female",
        address: "ارومیه - خیابان دانش - کوچه آفتاب",
        about: "متخصص طب خواب با تمرکز بر درمان اختلالات خواب و خروپف، عضو انجمن خواب ایران، دارای گواهینامه پلی‌سومنوگرافی",
        phone: "044-35264789",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "male",
        address: "زاهدان - خیابان آزادی - کوچه صدف",
        about: "متخصص طب پیشگیری با تمرکز بر غربالگری سرطان و پیشگیری از بیماری‌های قلبی، عضو انجمن طب پیشگیری ایران، دارای گواهینامه غربالگری پیشرفته",
        phone: "054-33659874",
        services_types: [
            {
                type: "online",
    ...
    },
    {
        ...
        gender: "female",
        address: "بندرعباس - خیابان ساحلی - کوچه دریا",
        about: "متخصص طب اعتیاد با تمرکز بر درمان اعتیاد و سم‌زدایی، عضو انجمن طب اعتیاد ایران، دارای گواهینامه درمان اعتیاد پیشرفته",
        phone: "076-35264789",
        services_types: [
            {
                type: "inPerson",
    ...
    },
    {
        ...
        gender: "male",
        address: "همدان - خیابان بوعلی - کوچه حکیم",
        about: "متخصص طب سفر با تمرکز بر واکسیناسیون و درمان بیماری‌های مناطق گرمسیری، عضو انجمن طب سفر ایران، دارای گواهینامه بین‌المللی طب سفر",
        phone: "081-33659874",
        services_types: [
            {
                type: "inPerson",
